    ...
    <div class="container">
        ...
        <div class="card">
           <div class="container-form">
               <div class="logo">
                <img src="${pageContext.request.contextPath}/img/logo.png" alt="logo Active Point++" class="imagem-logo">
                </div>
                <form>
                    ...
                    <button type="button" onclick="mostrarOpcoesCadastro()">Cadastre-se</button>
                </form>
            </div>
        </div>
...
<script>
    ...
    function mostrarOpcoesCadastro() {
        Swal.fire({
            ...
            confirmButtonText: 'Aluno',
            cancelButtonText: 'Professor',
            cancelButtonColor: '#Ff7f00',
            confirmButtonColor: '#09F8F8',
            icon: 'question',
        }).then((result) => {
            if (result.isConfirmed) {
                        window.location.href = "${pageContext.request.contextPath}/AlunoNovoCadastro";
            } else if (result.dismiss === Swal.DismissReason.cancel) {
                        window.location.href = "${pageContext.request.contextPath}/ProfessorNovoCadastro";
            }
        });
    }
 </script>
