...
@WebServlet(name = "ProfessorNovoCadastro", urlPatterns = {"/ProfessorNovoCadastro"})
public class ProfessorNovoCadastro extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/cadastros/cadastrarProfessor.jsp").forward(request, response);
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ProfessorNovoCadastro.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
