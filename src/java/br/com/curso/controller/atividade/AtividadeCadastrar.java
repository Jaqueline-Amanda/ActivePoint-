...
public class AtividadeCadastrar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        int pontuacaofinal = Integer.parseInt(request.getParameter("pontuacaofinal"));
       ...
       try{
           ...
           TurmaDAO oTurma = new TurmaDAO();
           oAtividade.setTurma((Turma) oTurma.carregar(idTurma));
           ...
           oAtividade.setPontuacaofinal(pontuacaofinal);
