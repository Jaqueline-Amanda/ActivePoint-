...
<div class="row">
                ...
                <table class="table table-striped table-bordered basic-datatable" id="datatable" width="98%" cellspacing="0">
                    ...
                    <tbody>
                        <c:forEach var="turma" items="${turmas}"> 
                            <tr>
                                <td align="left">${turma.idTurma}</td>
                                <td align="left">${turma.numTurma}</td>
                                <td align="left">${turma.disciplina.nomeDisciplina}</td>
                                ...
                                <td align="center">
                                    <a href="#" id="deletar" title="Excluir"
                                       onclick="deletar(${turma.idTurma}, '${turma.situacao == 'A' ? 'inativar': 'ativar'}')">
                                ...
                                <td align="center">
                                    <a href="${pageContext.request.contextPath}/TurmaCarregar?idTurma=${turma.idTurma}">
 ...
 <div align="center">
     <a href="${pageContext.request.contextPath}/TurmaNovo">Novo</a>
...
<script>
   $(document).ready(function(){
        ...
        var id = codigo;
        var mensagemSucesso = (acao === 'inativar') ? 'Turma inativada com sucesso!' : 'Turma ativada com sucesso!';
        var mensagemErro = (acao === 'inativar') ? 'Não foi possível inativar a Turma!' : 'Não foi possível ativar a Turma!';
        console.log(codigo);
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    type: 'post',
                    url: '${pageContext.request.contextPath}/TurmaExcluir',
                    data: {
                        idTurma: id
                    },
                    success:
                        function(data) {
                            ...
                            setTimeout(() => {window.location.href  = "${pageContext.request.contextPath}/TurmaListar"}, 2000);
                        },
                    error:
                        function(data){
                            setTimeout(() => {window.location.href =  "${pageContext.request.contextPath}/TurmaListar"}, 2000);
